...
const SERIES_KEY = "anonymes";

const works: Work[] = seriesData[SERIES_KEY].map((work, i) => ({
    ...work,
    image: `/plexiglas/anonymes-mini/renaud-delorme-artiste-anonyme-${i + 1}.webp`,
}));

export default function AnonymesClient() {
 ...
 const [failedImages, setFailedImages] = useState<number[]>([]);
  ...
  <div
    ...
    "
  >
    Manequins, simples anonymes, prises de vues de film ou même anciennes célébrités forment les sujets de cette série.
  </div>
)}
