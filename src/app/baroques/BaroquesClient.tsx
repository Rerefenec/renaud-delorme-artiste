  ...
  return (
    ...
    "
        >
          ...
          Tout semble vibrer, osciller entre l&apos;ordre et le débordement. Ces
          œuvres invitent à se perdre dans un labyrinthe de détails où chaque
          fragment paraît animé d&apos;une vie propre.
        </div>
      )}
