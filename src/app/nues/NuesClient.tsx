...
const SERIES_KEY = "nues";

const works: Work[] = seriesData[SERIES_KEY].map((work, i) => ({
    ...work,
    image: `/plexiglas/nues-mini/renaud-delorme-artiste-nue-${i + 1}.webp`,
}));

export default function NuesClient() {
 ...
 const [failedImages, setFailedImages] = useState<number[]>([]);
  ...
  <div
    ...
    "
  >
    Dans cette série,je réalise des images de nus de personnes célèbres ou pas.Je choisi parfois d'habiller mes nus avec des panoplies de super héros.
  </div>
)}
